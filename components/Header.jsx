        ...
        <div className="container mx-auto mb-8 px-10">
            <div className=" flex w-full items-center justify-between border-b border-blue-400 py-8">
                <div className="md:float-left">
                    <Link href="/">
                        {/* <span className="cursor-pointer text-3xl font-bold text-white bg-white"> */}
                            <svg
                                ...
                                viewBox="0 0 100 100"
                                xmlSpace="preserve"
                                className="cursor-pointer text-3xl font-bold text-white h-full w-[3rem]"
                            >
                                <path
